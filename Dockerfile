...
ARG VITE_JUSSILOG_BACKEND_DOCS_URL
ENV VITE_JUSSILOG_BACKEND_DOCS_URL=${VITE_JUSSILOG_BACKEND_DOCS_URL}
...
ARG VITE_JUSSI_AIBOT_API_URL
ENV VITE_JUSSI_AIBOT_API_URL=${VITE_JUSSI_AIBOT_API_URL}
ARG VITE_JUSSI_AIBOT_AI_SECRET_KEY
ENV VITE_JUSSI_AIBOT_AI_SECRET_KEY=${VITE_JUSSI_AIBOT_AI_SECRET_KEY}
...
ARG VITE_CV_ENDPOINT
ENV VITE_CV_ENDPOINT=${VITE_CV_ENDPOINT}
