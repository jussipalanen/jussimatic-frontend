...
export const DEMOS: Demo[] = [
  {
    ...
    badges: [
      { label: 'React', colorClass: 'bg-cyan-400/15 text-cyan-300 font-semibold' },
  ...
  },
  {
    id: 'jussilog-backend',
    path: '',
    externalUrl: import.meta.env.VITE_JUSSILOG_BACKEND_DOCS_URL,
    labelKey: 'jussilogBackendCta',
    subtitleKey: 'jussilogBackendSubtitle',
